...
function Balao_moser(entry, idioma) {
    ...
    if (idioma == "pt") {
        messages = {
            ...
            "fluxograma-sm": "A camada de materiais não consolidados<br>(solos, depósitos aluvionares, etc.) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
            ...
            "label-sm-menor": "Existe uma camada espessa de materiais<br>não consolidados (solos, depósitos aluvionares, etc.) sobre<br>o deposótio mineral?",
            "label-sm-maior": "Existe uma camada espessa de materiais<br>não consolidados (solos, depósitos aluvionares, etc.) sobre<br>o deposótio mineral?",
        }
    } else {
        messages = {
            "fluxograma-logistica": "Is the mine going to utilize trucks?",
            "fluxograma-rock": "Is the rock mass classification less than 5 (I-V)?",
            "fluxograma-sm": "Is the layer of unconsolidated materials (soils, aquifers, ...)<br>over the mineral deposit less than 70 m thick?",
...
function Balao_la_vergne(entry, idioma) {
    ...
    if (idioma == "pt") {
        messages = {
            "fluxograma-sm": "Existe uma camada espessa de materiais<br>não consolidados (solos, depósitos aluvionares, etc.) sobre<br>o deposótio mineral?",
        ...
        messages = {
            "fluxograma-sm": "Is there a thick layer of unconsolidated<br>materials (soils, aquifers, ...) over the mineral deposit?",
            ...
            "fluxograma-shaft": "Utilize a shaft and elevators",
            "label-sm-menor": "Is there a thick layer of unconsolidated<br>materials (soils, aquifers, ...) over the mineral deposit?",
            "label-sm-maior": "Is there a thick layer of unconsolidated<br>materials (soils, aquifers, ...) over the mineral deposit?",
...
function Balao_cardozo(entry) {
    ...
    if (idioma == "pt") {
        messages = {
            ...
            "fluxograma-rampa": "Utilizar rampa e caminhões",
            "fluxograma-shaft": "Utilizar poço e elevador",
            "label-sm-menor": "A camada de materiais não consolidados<br>(solos, depósitos aluvionares, etc.) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
            "label-sm-maior": "A camada de materiais não consolidados<br>(solos, depósitos aluvionares, etc.) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
        ...
        messages = {
            "fluxograma-sm": "Is the thickness of unconsolidated materials (soils, aquifers, ...) over the mineral deposit greater than 70 m?",
            "fluxograma-rock": "Is the rock intact (without joints/fractures)<br> and of good quality/strength?",
            ...
            "fluxograma-ramp": "Utilize ramps and trucks",
            "fluxograma-shaft": "Utilize a shaft and elevators",
            "label-sm-menor": "Is the thickness of unconsolidated materials (soils, aquifers, ...) over the mineral deposit greater than 70 m?",
            "label-sm-maior": "Is the thickness of unconsolidated materials (soils, aquifers, ...) over the mineral deposit greater than 70 m?",
