function Balao_moser(entry) {
    ...
    if (idioma == "pt") {
        messages = {
            ...
            "fluxograma-sm": "A camada de materiais não consolidados<br>(solos, aquíferos, etc.] ) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
...
function Balao_la_vergne(entry) {
    ...
    if (idioma == "pt") {
        messages = {
            "fluxograma-sm": "Existe uma camada espessa de materiais<br>não consolidados (solos, aquíferos, etc.) sobre<br>o deposótio mineral?",
            ...
            "label-sm-menor": "Existe uma camada espessa de materiais<br>não consolidados (solos, aquíferos, etc.) sobre<br>o deposótio mineral?",
            "label-sm-maior": "Existe uma camada espessa de materiais<br>não consolidados (solos, aquíferos, etc.) sobre<br>o deposótio mineral?",
...
function Balao_cardozo(entry) {
    ...
    if (idioma == "pt") {
        messages = {
            ...
            "fluxograma-rampa": "Utilizar rampa e caminhões",
            "fluxograma-shaft": "Utilizar poço e elevador",
            "label-sm-menor": "A camada de materiais não consolidados<br>(solos, aquíferos, etc.) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
            "label-sm-maior": "A camada de materiais não consolidados<br>(solos, aquíferos, etc.) sobre o deposótio mineral possui<br>espessura menor que 70 m?",
